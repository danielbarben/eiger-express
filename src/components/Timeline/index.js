    ...
    return (
      <div className='element'>
        ...
        <ul className='events'>
          ...
          <li><p className='date'>15.12.2019</p><p>Die Züge aus Interlaken halten nun direkt am Terminal</p></li>
          <li><p className='date'>30.4.2020</p><p>Die Seile des Eiger-Express werden eingezogen. Das dauert bis im August</p></li>
          <li><p className='date'>4.12.2020</p><p>Das Parkhaus beim Terminal mit 1’000 Plätzen wird eröffnet</p></li>
          <li><p className='date'>4.12.2020</p><p>Der Eiger-Express wird sieben Tage früher als geplant eröffnet</p></li>
        </ul>
      </div>
    );
  }
